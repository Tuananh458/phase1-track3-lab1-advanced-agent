...
def build_report(records: list[RunRecord], dataset_name: str, mode: str = "mock") -> ReportPayload:
    ...
    discussion = (
        ...
        "Our analysis shows that incorporating explicit self-reflection yields a significant performance improvement "
        "by forcing the agent to verify the semantic links between multi-hop entities before outputting the final result."
    )
